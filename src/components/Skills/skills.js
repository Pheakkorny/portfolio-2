        ...
        <div className='skillBars'>
            <div className='skillBar'>
                ...
                <div className='skillBarText'>
                    ...
                    <p>Building or write Front-End Side (web pages) by using HTML, CSS, JavaScript, or frameworks: Bootstrap, React.js. Vue.js .</p>
                </div>
            </div>
            <div className='skillBar'>
                ...
                <div className='skillBarText'>
                    ...
                    <p>Building or write back-End Side and API by using PHP, Node.js, Laravel, and Database: mySQL. </p>
                </div>
            </div>
            <div className='skillBar'>
            ...
            <div className='skillBar'>
                <img src={ITSupport} alt='AppDesignImg' className='skillBarImg'/>
                <div className='skillBarText'>
                    <h2>IT Support skills</h2>
                    <p>With my education and my experience I can solving the problem, Maintanaince computer, printer and basic networks, I am also learning IT Support course at CITA institute .</p>
                </div>
            </div>
        </div>
    </section>
